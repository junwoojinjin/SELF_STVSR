...
def vimeo7():
    ...
    if mode == 'GT':
        img_folder = '/mnt/ssd0/junwoojin/datas/vimeo_septuplet/test_sequences_LR/HR/x4'
        lmdb_save_path = '/mnt/ssd0/junwoojin/datas/vimeo_septuplet/sequences/vimeo7_test_GT.lmdb'
        txt_file = '/mnt/ssd0/junwoojin/datas/vimeo_septuplet/sep_testlist.txt'
        H_dst, W_dst = 256, 448

    elif mode == 'LR':
        img_folder = '/mnt/ssd0/junwoojin/datas/vimeo_septuplet/test_sequences_LR/LR/x4'
        lmdb_save_path = '/mnt/ssd0/junwoojin/datas/vimeo_septuplet/sequences/vimeo7_test_LR7.lmdb'
        txt_file = '/mnt/ssd0/junwoojin/datas/vimeo_septuplet/sep_testlist.txt'
        H_dst, W_dst = 64, 112
...
if __name__ == "__main__":
    vimeo7()
    #test_lmdb('/mnt/ssd0/junwoojin/datas/vimeo_septuplet/vimeo7_train_LR7.lmdb', 'vimeo7')
