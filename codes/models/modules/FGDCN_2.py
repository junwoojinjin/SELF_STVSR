...
class FlowGuidedDCN2(nn.Module):
    def __init__(self,
        ...
        self.offset_conv_2 = nn.Sequential(
            nn.Conv2d(self.out_channels + 2, 2 * groups * kernel_size[0] * kernel_size[1], 3, 1, 1),
        )
        self.offset_conv.apply(init_weights)
        self.offset_conv_2.apply(init_weights)
